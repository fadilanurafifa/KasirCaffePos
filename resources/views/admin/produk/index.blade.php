...
<style>
    ...
    .produk-card {
        width: 180px; /* Lebih kecil dari sebelumnya */
        background: #fff;
        border-radius: 8px;
    ...
    <div class="produk-container">
        <div class="produk-container">
            ...
            <div class="produk-card" data-id="{{ $prd->id }}" data-nama="{{ $prd->nama_produk }}" 
                ...
                <p style="font-size: 12px; color: #666;">Kategori: {{ $prd->kategori ? $prd->kategori->nama_kategori : 'Tanpa Kategori' }}</p>
            </div>
            @endforeach
        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img id="detailFotoProduk" src="" alt="Produk" style="max-width: 100%; height: 250px; object-fit: cover; border-radius: 10px;">
